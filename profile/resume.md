...
时间：2022.06 - 2026.04  
职级成长：P4 Java 初级开发工程师（校招）→ P5 Java 高级开发工程师 → P6 Java 资深开发工程师
...
- 独立承担需求分析、方案设计、后端接口、Vue3 页面、联调测试、灰度发布和线上问题治理。

### P6 · Java 资深开发工程师

时间：2024.10 - 2026.04

- 主导订单分库分表与 ES 统一查询平台、订单拆单系统标准化重构、查询模板标准化、AI 查询 Skill 和大促稳定性治理。
- 推动订单查询、ES 搜索、拆单等基础能力平台化，提升系统可维护性、扩展能力和业务接入效率。
